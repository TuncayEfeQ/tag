...
async def start(event):
  await event.reply("**Ben Tagger Bot**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'https://t.me/sanalinsahipleri?startgroup=a'),
                      Button.url('📣 Geliştirici', 'https://t.me/jelibonvsp')]
                    ),
                    link_preview=False
                   )
...
print(">> Bot çalıyor merak etme 🚀 @jelibonvsp bilgi alabilirsin <<")
